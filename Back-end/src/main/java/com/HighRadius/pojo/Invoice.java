...
public class Invoice {
	...
	public Invoice(int sl_no,String business_code, long cust_number, String clear_date, int buisness_year, String doc_id,
			String posting_date, String document_create_date, String due_in_date, String invoice_currency,
			String document_type, long posting_id, float total_open_amount, String baseline_create_date,
	...
	/*public Invoice(String business_code, long cust_number, String clear_date, int buisness_year, String doc_id,
			String posting_date, String document_create_date, String due_in_date, String invoice_currency,
			String document_type, long posting_id, float total_open_amount, String baseline_create_date,
			String cust_payment_terms, long invoice_id) 
	{
